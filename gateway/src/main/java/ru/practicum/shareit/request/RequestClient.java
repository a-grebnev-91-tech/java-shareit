...
public class RequestClient extends BaseClient {
    ...
    public ResponseEntity<Object> createRequest(long requesterId, RequestInputDto dto) {
        return post("", requesterId, dto);
    }

    public ResponseEntity<Object> getAllRequestsButUser(long userId, int from, int size) {
